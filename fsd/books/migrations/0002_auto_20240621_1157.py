...
def create_book_data(apps, schema_editor): 
    ...
    Book.objects.bulk_create([Book(title='To Kill a Mockingbird', author='Harper Lee', publication_date='1960-07-11'), 
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(create_book_data, atomic=False),
